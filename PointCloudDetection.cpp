...
public:
    ...
    void log(const std::string& stageName) {
        auto now = Clock::now();
        std::chrono::duration<double> elapsed = now - last;
        std::cout << stageName << " took: " << elapsed.count() << " seconds\n";
        last = now;
    }
...
int main(int argc, char** argv)
{
    ...
    timer.log("processed pointcloud");
